...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-63490c4f62729d73"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Geometry, Discrete geometry; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-63490c4f62729d73",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-63490c4f62729d73",
        "url": "https://en.wikipedia.org/wiki/K-set_(geometry)"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Finding matching upper and lower bounds for k -sets and halving lines",
      "version": 1
    },
    "title": "Finding matching upper and lower bounds for k -sets and halving lines",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "f01c97f2cf2e7a0b810ee1dad13211adce6fa7b68156067b5162e1d3b9f92ae4"
}
```
